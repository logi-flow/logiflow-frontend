...
interface Props {
  ...
  onClose: () => void;
  onEdit: () => void;
  onDelete: (deductionTypeId: number) => void;
}

function DeductionTypeDetailModal({ deductionType, open, loading, onClose, onEdit, onDelete }: Props) {
  ...
  const handleConfirmDelete = () => {
    if (loading || !deductionType) return;

    onDelete(deductionType.id);
...
export default DeductionTypeDetailModal;