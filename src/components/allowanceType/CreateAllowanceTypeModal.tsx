...
interface Props {
  ...
  loading: boolean;
  onClose: () => void;
  onConfirm: (dto: CreateAllowanceTypeRequestDto) => void;
}

function CreateAllowanceTypeModal({ open, loading, onClose, onConfirm }: Props) {
  ...
  const handleConfirmCreate = () => {
    ...
    const dto: CreateAllowanceTypeRequestDto = form;
    onConfirm(dto);
  ...
  return (
    ...
    >
      ...
      <DialogContent dividers>
        {loading ? (
          ...
          <Stack spacing={2}>
            ...
            <form id="createAllowanceTypeForm" onSubmit={handleSubmit}>
      ...
      <DialogActions>
        <Button type="submit" form="createAllowanceTypeForm" disabled={loading || isCodeEmpty || isNameEmpty}>
          완료
        </Button>
      </DialogActions>
...
export default CreateAllowanceTypeModal;