...
interface Props {
  log: PageDto<GetDriverAllowanceUpdateLogResponseDto>;
  open: boolean;
  loading: boolean;
  onClose: () => void;
...
function DriverAllowanceLogsModal({ log, open, loading, onClose, onChangePage }: Props) {
  const size = 20;
  const sort = "desc";
...
export default DriverAllowanceLogsModal;