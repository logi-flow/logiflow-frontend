...
export const GET_MY_ASSIGNMENT_URL = `${ASSIGNMENT_MODULE_URL}/me`;
export const GET_ALL_ASSIGNMENT_URL = `${ASSIGNMENT_MODULE_URL}`;
export const GET_ASSIGNMENT_DETAIL_URL = (assignmentId: number) => `${ASSIGNMENT_MODULE_URL}/${assignmentId}`;
export const DELETE_ASSIGNMENT_URL = (assignmentId: number) => `${ASSIGNMENT_MODULE_URL}/${assignmentId}`;
